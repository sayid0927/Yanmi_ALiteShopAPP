...
//        if(!hasMenuKey && !hasMenuKey){
//            Resources resource = getResources();
//            int resourceId=resource.getIdentifier("navigation_bar_beight","dimen","android");
...
//        getWindow().getDecorView().findViewById(view).setPadding(0,0,0,getNavigationBarHeight());
//    }
